...
const add_recruiter = async (req, res) => {
    ...
    if (!req.body.firstName || !req.body.lastName || !req.body.age || !req.body.bio || !req.body.workExp || !req.body.currStatus || !req.body.options) {
...
const view_recruiter_profile_picture = async (req, res) => {
    if(req.body){
        ProfilePicture.find({ _id: req.body.uid }, function (err, docs) {
            if (err) {
